...
function Feedback()
{
    ...
    user1 = new Customer("Vasu" , "5 star" , "Bangalore","me-info@example.com");
    user2 = new Customer("Aravind" , "4 star" , "Chennai","hi-data@example.in");
    user3 = new Customer("Prasanna" , "4 star" , "Chennai","me-info@example.comfs");

    user4 = new Customer("Ashik" , "4 star" , "Trichy","me-info@example.com");
    user5 = new Customer("Vinoth" , "4 star" , "Chennai","hi-data@example.in");
    user6 = new Customer("Dhinesh" , "5 star" , "Thanjavur","me-info@example.comfs");
