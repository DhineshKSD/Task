...
[
    ...
    flight: [
    {flight_details: "Flight Name: Air India Express, Flight No : AIE 573 ,  Departure: 05.20 AM, Arrival: 12.25PM", Price: "6662"},
    {flight_details: "Flight Name: Singapore Airlines , Flight No : SQ 529,  Departure: 11.40 PM,  Arrival: 05.45AM", Price: "7549"},
    {flight_details: "Flight Name: Air-India , Flight No : AI 863 ,  Departure: 11.35 AM, Arrival: 06.05PM", Price: "8512"},
    ]
   }
  ]
...
{   
    ...
    var h = JSON.parse(localStorage.getItem("govt_id"));
    h.splice(id, 1);
    traveller = JSON.stringify(h);
